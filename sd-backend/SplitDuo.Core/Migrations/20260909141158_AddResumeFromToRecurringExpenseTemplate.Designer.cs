...
namespace SplitDuo.Core.Migrations
{
    ...
    [Migration("20260909141158_AddResumeFromToRecurringExpenseTemplate")]
    partial class AddResumeFromToRecurringExpenseTemplate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SplitDuo.Core.Domain.Entities.AiCallLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("SplitDuo.Core.Domain.Entities.Expense", b =>
                {
                    ...
                    b.HasIndex("GroupId", "ExpenseTypeId", "ExpenseDate");
            ...
            modelBuilder.Entity("SplitDuo.Core.Domain.Entities.ExpenseAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("SplitDuo.Core.Domain.Entities.User", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Settings", "SplitDuo.Core.Domain.Entities.User.Settings#UserSettings", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("SplitDuo.Core.Domain.Entities.UserAvatar", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
