...
public class TwoFactorToken : AuditableEntity
{
    ...
    [Column("token_type"), MaxLength(50)] public string TokenType { get; set; } = ""; // "email_verification", "login_code"
    [Column("purpose"), MaxLength(100)] public string Purpose { get; set; } = ""; // "2fa_setup", "2fa_login", "account_verification"
